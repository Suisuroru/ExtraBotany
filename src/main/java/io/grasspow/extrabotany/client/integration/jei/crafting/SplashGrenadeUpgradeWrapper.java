...
public class SplashGrenadeUpgradeWrapper implements ICraftingCategoryExtension {
    private final ResourceLocation name;

    public SplashGrenadeUpgradeWrapper(SplashGrenadeRecipe recipe) {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, ICraftingGridHelper helper, IFocusGroup focusGroup) {
        ...
        for (var will : !foci.isEmpty() ? foci : willStacks) {
            var stack = new ItemStack(ExtraBotanyItems.SPLASH_GRENADE.get());
