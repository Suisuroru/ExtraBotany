...
public class ModRecipeTypes {
    ...
    public static final RegistryObject<RecipeType<PedestalRecipe>> PEDESTAL_CLICK = RECIPE_TYPES.register(LibRecipeNames.PEDESTAL_CLICK, () -> registerRecipeType(LibRecipeNames.PEDESTAL_CLICK));
    public static final RegistryObject<RecipeSerializer<PedestalRecipe>> PEDESTAL_CLICK_SERIALIZER = RECIPE_SERIALIZERS.register(LibRecipeNames.PEDESTAL_CLICK, PedestalRecipe.Serializer::new);
