...
public class LibItemNames {
    ...
    public static final String MANA_DRIVE_RING = "mana_drive_ring";
    ...
    public static final String SAGES_MANA_RING = "sages_mana_ring";
    public static final String EXCALIBER = "excaliber";
    public static final String FAILNAUGHT = "failnaught";
    public static final String CORE_GOD = "core_god";
    public static final String ACHILLED_SHIELD = "achilled_shield";
    public static final String BUDDHIST_RELICS = "buddhist_relics";
    public static final String CAMERA = "camera";

    public static final String SPIRIT_FUEL = "spirit_fuel";
    public static final String NIGHTMARE_FUEL = "nightmare_fuel";
    public static final String GILDED_MASHED_POTATO = "gilded_mashed_potato";
    ...
    public static final String GOLD_CLOTH = "gold_cloth";
